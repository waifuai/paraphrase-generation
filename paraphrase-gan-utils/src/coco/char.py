...
# Flags for character-level model.
flags.DEFINE_string('data_dir', './char_data', 'Path to the data directory.')
...
# File names for char-level data.
...
def main(_):
    ...
    download_and_process_data(data_dir, tmp_dir, TRAIN_FILE, VAL_FILE, VOCAB_FILE, FLAGS.max_len, mode='char')
